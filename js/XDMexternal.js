        ...
        $(function(){
            ...
            var widgetObject = {
                ...
                cheetahWidget2012_IframeHeight: function (apikey,buttonPosition,hostUrl,pluginType,outTime){
                    $('#cheetahWidget2012_contactForm').html("");
            ...
            onMessage: function(message,origin){
                ...
                switch(data.type){
                    ...
                    $("#dropifiwidget_iframe").css({'padding':'0px','margin':'0px','overflow':'hidden','border':'0px'});
                    
                    $('.widget-container #widget-form').css({'height':h+"px"});
                    DropifiWidgetLoad.resetCFPosition();
                    
                    break;
                    case 'closeWindow': DropifiWidgetLoad.dropifi_widget_reload_content = true;
                    ...
                    $('#dropifi_widget_v1_contactable #cheetahWidget2012_contactForm').css({'height':h+"px"});
...
toArrayJSon: function(message){
    var arr={};
    $.each(message.split(','),function(key,val){
